...
public class ComandoTest {
    ...
    void testCargar() {
        ITarea cargar = new Carge(Robot.getMinutosParaCargaCompleta());
    ...
    void testLigOn() {
        ...
        ITarea encenderLuz = new LigOn(h);
